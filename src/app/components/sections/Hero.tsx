...
function Hero() {
  return (
    <div className={`bg-hero dark:bg-dark-hero bg-cover bg-left-bottom flex flex-col px-5 py-8 lg:px-12 lg:py-16 gap-5 w-full rounded-lg dark:text-light-gray text-dark-purplish-blue font-medium`}>
